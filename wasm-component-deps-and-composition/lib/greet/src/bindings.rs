...
macro_rules! __export_greetable_provider_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasm_study::greet::greetable::__export_wasm_study_greet_greetable_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wasm_study::greet::greetable);
    };
}
#[doc(inline)]
pub(crate) use __export_greetable_provider_impl as export;
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.31.0:wasm-study:greet:greetable-provider:encoded world"]
#[doc(hidden)]
...
\x01\x1awasm-study:greet/greetable\x05\0\x04\x01#wasm-study:greet/greetable-prov\
ider\x04\0\x0b\x18\x01\0\x12greetable-provider\x03\0\0\0G\x09producers\x01\x0cpr\
